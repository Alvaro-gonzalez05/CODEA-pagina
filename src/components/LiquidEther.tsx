...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class CommonClass implements ICommonClass {
      width: number;
      height: number;
      aspect: number;
      pixelRatio: number;
    ...
    class MouseClass implements IMouseClass {
      mouseMoved: boolean;
    ...
    class AutoDriver implements IAutoDriver {
      mouse: IMouseClass;
      manager: any;
      enabled: boolean;
      speed: number;
      ...
      constructor(mouse: IMouseClass, manager: any, opts: any) {
        this.mouse = mouse;
